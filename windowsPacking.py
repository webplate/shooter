...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Glen Lomax"
        self.author_email = "example@example.com"
        self.copyright = "Copyright (c) 2009 Glen Lomax"
 
        #Description
        self.project_description = "An old school flavored shooter"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = 'shooter.ico'
 
        #Extra files/dirs copied to game
        self.extra_datas = ['imgs', 'fonts', 'sounds']
 
        #Extra/excludes python modules
        self.extra_modules = []
        self.exclude_modules = ["Tkinter", "tcl", "OpenGL", "Numeric",
        "wxPython", "pyglet"]
